...
$status=$_POST['status'];
$sql="update formateur set nom=:tname,email=:email,tele=:mobilenumber,Address=:address,TeacherSub= :tsubjects,JoiningDate=:joiningdate,teachingExp=:teachexp,isPublic=:status where ID=:eid";
