        ...
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
               <div class="row mb-2">
                  <div class="col-sm-6 animated bounceInRight">
                     <h1 class="m-0" style="color: rgb(241, 9, 9);">Ajouter séance </h1>
                  </div>
                  <!-- /.col -->
                  <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Ajouter séance</li>
                     </ol>
                  </div>
                  <!-- /.col -->
               </div>
         ...
         <section class="content">
           ...
           <div class="card-header">
             <h3 class="card-title">Séance Information</h3>
           </div>
           <!-- /.card-header -->
           <!-- form start -->
           <form method="POST">
        ...
        <div class="row">
          ...
          <div class="form-group">
            ...
            <select class="form-control" name="salle">
                ...
                // Retrieve students from database
                $sql = "SELECT * FROM ressource where type_r ='salle' ";
                $result = mysqli_query($conn, $sql);
                if ($result && mysqli_num_rows($result) > 0) {
                  while ($row = mysqli_fetch_assoc($result)) {
                    echo "<option value='" . $row['nom'] . "'>" . $row['nom'] . "</option>";
