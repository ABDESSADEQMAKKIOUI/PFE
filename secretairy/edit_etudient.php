...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $address = $_POST['address'];
    ...
    $stmt = $conn->prepare("UPDATE etudiant SET first_name=? , last_name=? , gender=?, birthday=?, contact=?,email=?,address=? WHERE id=?");
    
    // Get the formateur ID from the URL
    $id = $_GET['id'];
    
    $stmt->bind_param("sssssssi",$first_name,$last_name,$gender ,$birthday,  $contact, $email,$address, $id);
      ...
      <div class="layout-page" style="margin-left: 5%;">
          ...
          <div class="content-wrapper" style="margin-left:-100%;margin-top: 5%;">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Paramètres du compte /</span> <?php echo $row['last_name']; ?> <?php echo $row['first_name']; ?></h4>
                      ...
                      <form id="formAccountSettings" method="POST" >
                        <div class="row">
                          <div class="mb-3 col-md-6">
                            ...
                            <input type="text" name="last_name" id="nom" class="form-control" value="<?php echo $row['last_name']; ?>" required>
                          </div>
                          <div class="mb-3 col-md-6">
                            <label for="lastName" class="form-label">Prénom</label>
                            <input type="text" name="first_name" id="prenom" class="form-control" value="<?php echo $row['first_name']; ?>" required>
                          </div>
                          <div class="mb-3 col-md-6">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <div class="input-group input-group-merge">
                              ...
                              <input type="tele" name="contact" id="tele" class="form-control" value="<?php echo $row['contact']; ?>" required>
                            </div>
                          </div>
                          <div class="mb-3 col-md-6">
