...
.btn-delete {
  ...
  color: white;
   ...
   <body class="hold-transition sidebar-mini layout-fixed">
    ...
    <h1 style="margin-left: -40%;">Liste des formations</h1>
        ...
        <tbody>
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>
                    <a href='edit_formation.php?id=" . $row["id"] . "'><button type='button' class='btn btn-primary btn-sm' style='marrgin-left:20%'>Modifier</button></a>
                    <a href='delete_formation.php?delete_id=" . $row['id'] . "' class='btn btn-danger btn-sm'>Supprimer</a>";
                    echo "</td>";
                    echo "</tr>";
                }
            } else {
